...
#> 
   ...
   Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>iwa-console</a></td></tr>" -Path createdApps.html
   ...
   $configFile = $pwd.Path + "\..\iwa-console\appsettings.json"
