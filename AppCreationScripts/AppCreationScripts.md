# Registering the Microsoft Entra applications and updating the configuration files for this sample using PowerShell scripts
...
1. In PowerShell run:
   ...
   ```
1. Run the script to create your Microsoft Entra application and configure the code of the sample application accordinly. (Other ways of running the scripts are described below)
   ```PowerShell
